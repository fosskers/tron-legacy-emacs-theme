...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-todo                                 ((,class (:box (:line-width 1 :color ,tron-lightgreen)
                                                        :foreground ,tron-lightgreen))))
   `(org-done                                 ((,class (:box (:line-width 1 :color ,tron-green)
                                                        :foreground ,tron-green))))
   ...
   `(magit-section-heading                    ((t (:foreground ,tron-lightblue))))
   ...
   `(diredfl-symlink                          ((t (:foreground ,tron-blue))))
